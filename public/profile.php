...
<div class="card mb-3"><div class="card-body"><h2 class="h6">Profile</h2><form method="post" class="row g-2"><input type="hidden" name="csrf_token" value="<?= e(csrf_token()) ?>"><input type="hidden" name="action" value="update_profile"><div class="col-md-8"><input class="form-control" name="name" value="<?= e((string) $user["name"]) ?>"></div><div class="col-md-4"><button class="btn btn-primary w-100">Update Profile</button></div></form></div></div>
<div class="card"><div class="card-body"><h2 class="h6">Change Password</h2><form method="post" class="row g-2"><input type="hidden" name="csrf_token" value="<?= e(csrf_token()) ?>"><input type="hidden" name="action" value="change_password"><div class="col-md-4"><input class="form-control" type="password" name="current_password" placeholder="Current password"></div><div class="col-md-4"><input class="form-control" type="password" name="new_password" placeholder="New password"></div><div class="col-md-4"><button class="btn btn-outline-primary w-100">Change Password</button></div></form></div></div>
</main></div></div>
