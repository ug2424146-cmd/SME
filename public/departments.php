...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    if (!verify_csrf_token($_POST["csrf_token"] ?? null)) {
        ...
        $controller->create($_POST, (int) $user["id"]);
    }
...
<div class="sidebar-wrapper">
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="<?= e(url('departments.php')) ?>" class="sidebar-link active">
                <span class="sidebar-link-icon">🏢</span>
...
<form method="post" class="row g-2 mb-3"><input type="hidden" name="csrf_token" value="<?= e(csrf_token()) ?>"><div class="col-md-8"><input class="form-control" name="department_name" placeholder="Department name" required></div><div class="col-md-4"><button class="btn btn-primary w-100">Add Department</button></div></form>
